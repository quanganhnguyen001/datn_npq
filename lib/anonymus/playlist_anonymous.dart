...
class PlaylistAnonymous extends StatefulWidget {
  const PlaylistAnonymous({
    Key? key,
    required this.index,
    required this.title,
  }) : super(key: key);
  ...
  final String title;
  @override
  State<PlaylistAnonymous> createState() => _PlaylistAnonymousState();
}

class _PlaylistAnonymousState extends State<PlaylistAnonymous> {
