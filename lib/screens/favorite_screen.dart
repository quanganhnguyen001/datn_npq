              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return ListTile(
                        ...
                        children: [
                          ...
                          MouseRegion(
                            ...
                            child: Stack(
                              children: [
                                Image.network(
                                    '${widget.userModel.favoriteSong?[index].coverUrl}'),
                                AnimatedOpacity(
                    ...
                    subtitle: Text(
                        '${widget.userModel.favoriteSong?[index].description}'),
                    trailing: GestureDetector(
                      onTap: () {
                        setState(() {
                          widget.userModel.favoriteSong
                              ?.remove(widget.userModel.favoriteSong?[index]);
                        });
                        ...
                        FirebaseFirestore.instance
                            ...
                            .update(UserModel(
                                    favoriteSong: widget.userModel.favoriteSong)
                                .toMap());
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          children: [
                            Image.network(
                              widget.userModel.favoriteSong?[songIndex]
                                      .coverUrl ??
                                  '',
                              width: 100,
                            ),
